export const VERCEL_SCHEMA_VERSION =
  "202608220001_site_layout_shared_storage";
...
const SITE_LAYOUT_SHARED_STORAGE_SCHEMA_SQL = `
...
CREATE INDEX IF NOT EXISTS site_layouts_updated_idx
  ON public.site_layouts (deleted_at, updated_at, id);

CREATE TABLE IF NOT EXISTS public.site_layout_revisions (
  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  site_layout_id bigint NOT NULL REFERENCES public.site_layouts(id) ON DELETE CASCADE,
  revision_number integer NOT NULL,
  parent_revision_id bigint NOT NULL DEFAULT 0,
  schema_version integer NOT NULL DEFAULT 3,
  draft_json text NOT NULL DEFAULT '{}',
...
CREATE UNIQUE INDEX IF NOT EXISTS site_layout_revisions_number_idx
  ON public.site_layout_revisions (site_layout_id, revision_number);
CREATE INDEX IF NOT EXISTS site_layout_revisions_created_idx
  ON public.site_layout_revisions (site_layout_id, created_at, id);

ALTER TABLE public.site_layouts ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.site_layout_revisions ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON public.site_layouts FROM anon, authenticated;
REVOKE ALL ON public.site_layout_revisions FROM anon, authenticated;
`;
...
${SITE_LAYOUT_SHARED_STORAGE_SCHEMA_SQL}

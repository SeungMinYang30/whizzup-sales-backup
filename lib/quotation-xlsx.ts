...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main">
  ...
  <sheetData>
    ...
    <row r="14" ht="34" customHeight="1">${inline("A14", "제품 상태·작동", 3)}${styledBlanks(14, ["B","C","D","E","F"], 3)}${inline("G14", "□ 정상", 21)}${inline("H14", "", 21)}${inline("I14", "□ 이상", 21)}${inline("J14", "", 21)}</row>
    ...
    <row r="19" ht="27" customHeight="1">${inline("A19", "No", 2)}${inline("B19", "품명", 2)}${inline("C19", "", 2)}${inline("D19", "규격", 2)}${inline("E19", "", 2)}${inline("F19", "견적", 2)}${inline("G19", "단위", 2)}${inline("H19", "현장", 2)}${inline("I19", "상태·작동", 2)}${inline("J19", "수량 확인", 2)}</row>
    ${productRows}

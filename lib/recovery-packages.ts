...
(function(){
  ...
  var labels={members:"구성원",activities:"기관 활동 기록",activity_authors:"기록 작성자",activity_assignment_history:"진행 담당자 변경 이력",activity_review_acknowledgements:"내 기록 점검 처리",manager_alert_acknowledgements:"관리자 알림 처리",ai_recommendations:"AI 대응 제안",app_settings:"사이트 설정",organization_locations:"기관 위치",sales_campaigns:"영업 묶음",sales_campaign_targets:"묶음 영업 대상",equipment_projects:"수주 사업",equipment_items:"사업 품목"};
  var preferred={members:["id","display_name","email","role","status","is_sales"],activities:["id","activity_date","organization","activity_type","topic","summary","status","follow_up_date","next_action","contact_role","contact_name"],activity_authors:["activity_id","created_by_name","created_at"],activity_assignment_history:["id","activity_id","from_manager","to_manager","changed_by_name","created_at"],activity_review_acknowledgements:["member_id","activity_id","issue_signature","snoozed_until","updated_at"],manager_alert_acknowledgements:["member_id","organization","issue_signature","snoozed_until","updated_at"],ai_recommendations:["id","activity_id","organization","meeting_summary","interests_json","recommended_products_json","follow_up_questions_json","recommended_actions_json","applied_products_json","applied_questions_json","applied_actions_json","follow_up_date"],app_settings:["key","value","updated_at"],organization_locations:["organization","region","address","latitude","longitude"],sales_campaigns:["id","name","notes","updated_at"],sales_campaign_targets:["id","campaign_id","organization","region","contact_name","phone","assigned_member_id"],equipment_projects:["id","organization","name","status","budget_type","notes"],equipment_items:["id","project_id","product_name","specification","proposed_qty","awarded_qty","installed_qty","status","execution_type","commission_input_type","commission_rate","consortium_commission_rate","consortium_payment_amount"]};

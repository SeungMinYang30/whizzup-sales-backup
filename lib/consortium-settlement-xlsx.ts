...
function settlementSheet(input: ConsortiumSettlementWorkbookInput, hasDrawing: boolean) {
  ...
  const finalPayment = Math.max(0, gross - consortiumCost - adjustmentDeductions + adjustmentAdditions);

...
function sheetXml(input: InternalProfitReportWorkbookInput) {
  ...
  return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main"><sheetPr><pageSetUpPr fitToPage="1"/></sheetPr><dimension ref="A1:N${endRow}"/><sheetViews><sheetView showGridLines="0" zoomScale="80" workbookViewId="0"><pane ySplit="14" topLeftCell="A15" activePane="bottomLeft" state="frozen"/></sheetView></sheetViews><sheetFormatPr defaultRowHeight="20"/><cols><col min="1" max="1" width="6" customWidth="1"/><col min="2" max="2" width="32" customWidth="1"/><col min="3" max="4" width="9" customWidth="1"/><col min="5" max="6" width="15" customWidth="1"/><col min="7" max="7" width="10" customWidth="1"/><col min="8" max="9" width="15" customWidth="1"/><col min="10" max="10" width="10" customWidth="1"/><col min="11" max="13" width="15" customWidth="1"/><col min="14" max="14" width="13" customWidth="1"/></cols><sheetData>
...
<row r="12" ht="25" customHeight="1">${textCell("A12","품목별 수익 내역",2)}${blanks(12,["B","C","D","E","F","G","H","I","J","K","L","M","N"],2)}</row>
...
export function createInternalProfitReportWorkbook(input: InternalProfitReportWorkbookInput) {
  ...
  return zipSync({
    ...
    "xl/worksheets/sheet1.xml": bytes(sheet), "xl/styles.xml": bytes(styles),
